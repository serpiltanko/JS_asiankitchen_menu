...
const button1 = document.createElement("button"); // add button element
button1.classList.add("btn", "btn-outline-dark", "btn-item"); // add classlist
button1.textContent = "All"; // add text in button
button1.id = "all"; // add an id for button1

const container1 = document.querySelector(".btn-container"); // assignment
...
// Create eventListener feature for button1
...
function allMenu() {
  ...
  let menuItems = menu.map((item) => {
    ...
    // menu of aforementioned array's objects (all foods) 
...
// Create eventListener feature for button2

let koreaButton = document.querySelector("#korea");
koreaButton.addEventListener("click", menuKorea);
...
function menuKorea() {
    ...
    //aforementioned array's objects divided by according to their categories' and created related menu screen
...
// Create eventListener feature for button3


let japanButton = document.querySelector("#japan");
japanButton.addEventListener("click", menuJapan);

//create button3 function
...
// Create eventListener feature for button4

let chinaButton = document.querySelector("#china");
chinaButton.addEventListener("click", menuChina);

//create button4 function
